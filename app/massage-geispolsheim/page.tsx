...
const publicCible = [
  ...
  "Personnes pratiquant régulièrement une activité physique",
  "Coureurs",
  "Cyclistes",
  "Danseurs",
  "Pratiquants de fitness",
  "Toute personne souhaitant travailler certaines tensions musculaires liées à son activité",
];
...
const contraindications = [
  ...
  {
    title: "Problème cardiovasculaire important ou événement cardiovasculaire récent",
...
export default function MassagePage() {
  return (
    <main className="bg-[#f6f0e7] text-[#5b3b2e]">
      {/* HERO */}
      <section className="overflow-hidden px-6 pb-20 pt-16 md:px-12 md:pb-28 md:pt-24">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              ...
              <Link
                href="/"
                className="rounded-full border border-[#cdb995] px-7 py-3.5 font-montserrat text-sm font-semibold text-[#5b3b2e] transition-all duration-300 hover:bg-[#e8dcc8]"
              >
                Retour à l&apos;accueil
              </Link>
            </div>
      ...
      <section className="bg-[#eee3d3] px-6 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="font-playfair text-3xl font-bold md:text-4xl">
              Pour qui est le massage ?
            </h2>

            <p className="mt-6 font-montserrat leading-8 text-[#76564a]">
              Contrairement à ce que son nom pourrait laisser penser, le
              massage sportif n&apos;est pas réservé aux sportifs professionnels.
              Il peut convenir à toute personne souhaitant travailler certaines
              tensions musculaires liées à son activité.
            </p>

            <p className="mt-4 font-montserrat leading-8 text-[#76564a]">
              Le massage est toujours adapté à la personne, à son état du
              moment et à ses objectifs.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            {publicCible.map((item) => (
              <div
                key={item}
                className="rounded-full bg-[#dcc6a3] px-5 py-3 font-montserrat text-sm text-[#654537]"
              >
                {item}
              </div>
            ))}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-6 font-montserrat text-sm leading-7 text-[#76564a]">
            ...
            <div className="space-y-4">
              {contraindications.map((item) => (
                <div
                  key={item.title}
                  className="rounded-2xl bg-[#f6f0e7] p-6"
                >
                  <h3 className="font-playfair text-lg font-bold">
                    {item.title}
                  </h3>

                  <p className="mt-2 font-montserrat text-sm leading-7 text-[#76564a]">
                    {item.text}
                  </p>
                </div>
              ))}
          ...
          <p className="mx-auto mt-10 max-w-4xl font-montserrat text-sm italic leading-7 text-[#987967]">
